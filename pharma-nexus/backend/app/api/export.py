...
def _build_report(hyp: Hypothesis) -> dict:
    return {
        ...
        "causal_dependency_score": hyp.causal_dependency_score,
        "mutation_context_score": hyp.mutation_context_score,
        "polypharmacology_score": hyp.polypharmacology_score,
        "pharmacological_response_score": hyp.pharmacological_response_score,
        "p_value": hyp.p_value,
        "fdr_adjusted_p_value": hyp.fdr_adjusted_p_value,
        "confidence_interval": hyp.confidence_interval,
        "dimension_confidence_intervals": hyp.dimension_confidence_intervals,
        "batch_id": hyp.batch_id,
        "scoring_method_version": hyp.scoring_method_version,
        "summary": hyp.summary,
