...
const navigation = [
  ...
  },
  {
    name: "Combinations",
    href: "/combinations",
    icon: "M13.19 8.688a4.5 4.5 0 0 1 1.242 7.244l-4.5 4.5a4.5 4.5 0 0 1-6.364-6.364l1.757-1.757m9.86-2.04a4.5 4.5 0 0 0-1.242-7.244l4.5-4.5a4.5 4.5 0 1 1 6.364 6.364l-1.757 1.757M7.5 21 3 16.5m0 0L7.5 12M3 16.5h13.5m0-13.5L21 7.5m0 0L16.5 12M21 7.5H7.5",
  },
  {
    name: "Tallula",
    href: "/tallula",
  ...
  const navContent = (
    <>
      <div className="p-5 flex items-center gap-3">
        ...
        <div>
          <h1 className="text-lg font-bold text-white">Pharma Nexus</h1>
          <p className="text-[11px] text-slate-400">Drug Repurposing Engine</p>
        </div>
      </div>
      ...
      <div className="p-3 border-t border-slate-800 space-y-2">
        ...
        <p className="px-3 text-[11px] text-slate-500">v0.2.0</p>
      </div>
    </>
  );
  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed top-4 left-4 z-40 md:hidden bg-slate-900 text-white p-2 rounded-lg shadow-lg"
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-50 w-64 bg-slate-900 text-white flex flex-col transform transition-transform duration-200 md:hidden ${
      ...
      {/* Desktop sidebar */}
      <aside
        className="hidden md:flex w-64 bg-slate-900 text-white flex-col flex-shrink-0"
        aria-label="Navigation sidebar"
      >
        {navContent}
      </aside>
